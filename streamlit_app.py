...
# إعداد الخريطة والتوسط الافتراضي بالمنطقة الشرقية
MAP_START_LAT = 26.50
MAP_START_LON = 50.00

st.subheader("🗺️ خريطة الصيد التفاعلية ومواقعك المثبتة:")
st.info("💡 تم تحديد مواقعك المفضلة بالنقط الحمراء. اضغط على أي علامة أو أي مكان في البحر لتحليل الطقس ونشاط السمك.")

m = folium.Map(location=[MAP_START_LAT, MAP_START_LON], zoom_start=8, control_scale=True)
m.add_child(folium.LatLngPopup())

# إضافة النقاط الحمراء المحددة (الحمراء، زبنة، العقير)
locations = {
    "مرفأ الحمراء (الجبيل)": [27.012, 49.663],
    "منطقة زبنة": [26.915, 49.782],
    "العقير": [25.652, 50.218]
}
